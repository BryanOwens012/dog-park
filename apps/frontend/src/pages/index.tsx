    ...
    <>
      ...
      <header style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
          <a href="#" style={{ color: '#e8eaed', textDecoration: 'none', fontSize: '13px' }}>About</a>
          <a href="#" style={{ color: '#e8eaed', textDecoration: 'none', fontSize: '13px' }}>Store</a>
        </div>
        
        <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
          <a href="#" style={{ color: '#e8eaed', textDecoration: 'none', fontSize: '13px' }}>Gmail</a>
          <a href="#" style={{ color: '#e8eaed', textDecoration: 'none', fontSize: '13px' }}>Images</a>
