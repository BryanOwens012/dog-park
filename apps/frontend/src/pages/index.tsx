    ...
    <>
      ...
      <div className="min-h-screen bg-gray-900 text-white">
        ...
        <main className="flex flex-col items-center justify-center flex-1 px-4" style={{ minHeight: 'calc(100vh - 200px)' }}>
          ...
          <form onSubmit={handleSearch} className="w-full max-w-2xl mb-8">
            <div className="relative">
              ...
              <input
                ...
                placeholder="Search Hoogle or type a URL"
                aria-label="Search"
                autoComplete="off"
              />
          ...
          <div className="mb-8">
            <button 
              className="bg-gray-800 hover:bg-gray-700 border border-gray-600 px-4 py-2 rounded-full text-sm text-gray-300 hover:text-white transition-colors flex items-center space-x-2"
